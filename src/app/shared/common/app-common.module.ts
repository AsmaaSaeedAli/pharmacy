...
import { LocalizedTextComponent } from './localization/localized-text.component';
import { LocalizedTextAreaComponent } from './localization/localized-text-area/localized-text-area.component';
