...
import { AlphabeticalValidator } from './validation/alphabetical-validator.directive';
import { AlphanumericValidator } from './validation/alphanumeric-validator.directive';
...
@NgModule({
    ...
    declarations: [
        AlphabeticalValidator,AlphanumericValidator,
        EqualValidator,
